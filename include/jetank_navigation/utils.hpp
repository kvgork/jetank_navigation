...
constexpr double diagonal_fov_to_horizontal(
  const double diagonal_fov, const double image_width,
...
constexpr double calculate_angle_increment(
  const double angle_min, const double angle_max,
  const int beam_density)
{
